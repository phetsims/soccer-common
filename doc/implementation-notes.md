...
This document contains notes related to the implementation of the common code repo _Soccer Common_. This project is a common code repo that defines model and view components for "soccer" related simulations. These
...
- The central model is the SoccerSceneModel, which contains SoccerBall instances and Kicker instances and other emitters
  and stateful dat.
